...
export const VEHICLE_CATEGORY_OPTIONS = [
  { label: '乘用车', value: VEHICLE_TYPES.PASSENGER },
  { label: '货车', value: VEHICLE_TYPES.TRUCK },
  { label: '专用车', value: VEHICLE_TYPES.SPECIAL },
  { label: '二类底盘', value: VEHICLE_TYPES.CHASSIS },
];
...
export const STORAGE_KEYS = {
  ...
  USER_INFO: 'certificate_user_info',
};
